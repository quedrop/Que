...
class DriverChatVC: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        imgDriverProfile.sd_setImage(with: URL(string: receiver_profile), placeholderImage: UIImage(named: "avtar"), context: nil)
       ...
       if orderStatus == OrderStatus.Delivered.rawValue || orderStatus == OrderStatus.Cancelled.rawValue{
    ...
    func setupRefreshData() {
        self.refresh.tintColor = #colorLiteral(red: 0.02953532711, green: 0.3329574764, blue: 0.3831532001, alpha: 1)
               ...
               case .connected?:
                APP_DELEGATE!.socketIOHandler?.GetSingleUserDetails(userID: receiver_id, completion: { (objUser) in
                    ...
                    if (objUser.firstName!.length) > 0
                    {
                        ...
                        name = "\(objUser.email?.components(separatedBy: "@")[0] ?? "")"
                    }
                    ...
                    self.imgDriverProfile.sd_setImage(with: URL(string: self.receiver_profile), placeholderImage: UIImage(named: "avtar"), context: nil)
                })
    ...
    @IBAction func btnSendClicked(_ sender: UIButton) {
        ...
        else
        {
           ...
           // dictMsg.setValue(strRandomId, forKey: "message_id")
            ...
            dictMsg.setValue("\(DriverChatVC.MessageVCMessageStatus.MessageVCMessageStatusSending.rawValue)", forKey: "status")
...
extension DriverChatVC:SocketIOHandlerDelegate {
...
extension DriverChatVC : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            if objMessage.senderId == USER_ID {
               ...
               // if let dt = objMessage.modifiedDate {
