...
public struct VAMonthHeaderViewAppearance {
    ...
    public init(
		monthFont: UIFont = UIFont(name: "Montserrat-Regular", size: 16.0)!,
		monthTextColor: UIColor = .gray,
...
public class VAMonthHeaderView: UIView {
    ...
    public override func layoutSubviews() {
        ...
        previousButton.frame = CGRect(x: 10, y: 0, width: buttonWidth, height: frame.height)
		nextButton.frame = CGRect(x: frame.width - (buttonWidth + 10), y: 0, width: buttonWidth, height: frame.height)
    }
