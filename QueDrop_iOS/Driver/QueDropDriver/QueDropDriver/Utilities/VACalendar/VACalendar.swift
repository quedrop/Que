...
public enum usedVACalendarFor {
    case AdvancedOrder
    case EarningDate
    case SingleStore
}
var currentlyUsingVACalenderFor : usedVACalendarFor = .EarningDate
...
public class VACalendar {
	...
	func getFormateddate(date : Date) -> Date
	{
    ...
    func selectDay(_ day: VADay) {
        ...
        case .AdvancedOrder:
            //if DateFormatter(format: "dd").string(from: day.date) ==  DateFormatter(format: "dd").string(from: Date()){
