...
public final class RegisteredStores: NSCoding {
  ...
  public required init(json: JSON) {
    storeAmount = json[SerializationKeys.storeAmount].float
  ...
  required public init(coder aDecoder: NSCoder) {
    self.storeAmount = aDecoder.decodeObject(forKey: SerializationKeys.storeAmount) as? Float
