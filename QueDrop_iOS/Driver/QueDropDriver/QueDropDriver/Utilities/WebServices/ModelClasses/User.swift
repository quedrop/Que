...
public class User: NSObject, NSCoding, JSONable {
  ...
  private let kUserRatingKey: String = "rating"
  private let kUserIsIdentityDetailUploadedKey: String = "is_identity_detail_uploaded"
  ...
  public var rating: Float?
    public var isIdentityDetailUploaded: Int?
  ...
  */
  required public init(json: JSON) {
    ...
    rating = json[kUserRatingKey].float
    isIdentityDetailUploaded = json[kUserIsIdentityDetailUploadedKey].int
  }
  ...
  */
  public func dictionaryRepresentation() -> [String: Any] {
    ...
    if let value = rating { dictionary[kUserRatingKey] = value }
    if let value = isIdentityDetailUploaded { dictionary[kUserIsIdentityDetailUploadedKey] = value }
    return dictionary
  }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.rating = aDecoder.decodeObject(forKey: kUserRatingKey) as? Float
    self.isIdentityDetailUploaded = aDecoder.decodeObject(forKey: kUserIsIdentityDetailUploadedKey) as? Int
  }
  ...
  public func encode(with aCoder: NSCoder) {
    ...
    aCoder.encode(rating, forKey: kUserRatingKey)
    aCoder.encode(isIdentityDetailUploaded, forKey: kUserIsIdentityDetailUploadedKey)
  }
