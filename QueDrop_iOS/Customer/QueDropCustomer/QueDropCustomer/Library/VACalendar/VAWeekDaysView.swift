...
public struct VAWeekDaysViewAppearance {
    ...
    public init(
        symbolsType: VAWeekDaysSymbolsType = .short,
		weekDayTextColor: UIColor = .gray,
        weekDayTextFont: UIFont = UIFont(name: "Montserrat-Regular", size: 15.0) ?? UIFont.systemFont(ofSize: 15),
        leftInset: CGFloat = 10.0,
        rightInset: CGFloat = 10.0,
        separatorBackgroundColor: UIColor = .clear,
        calendar: Calendar = Calendar.current) {
        self.symbolsType = .short
