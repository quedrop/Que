...
class LoginVC: BaseViewController, TTTAttributedLabelDelegate {
    ...
    let kEmail = "login_email"
    let kPassword = "login_password"
    let kIsRememberMe = "is_remember_me"
    ...
    //IBOUTLETS
    @IBOutlet var viewSocialLogin: UIView!
    ...
    let userTypeStr = UserType.rawValue
    var isFirst = true
...
//        }
       ...
       // setupGUI()
        ...
        //setupUserUI() // Hide Controls for supplier login
    ...
    func setupGUI() {
        ...
        isRememberMe = UserDefaults.standard.bool(forKey: kIsRememberMe + userTypeStr)
        txtEmail.text = UserDefaults.standard.string(forKey: kEmail + userTypeStr)
        txtPassword.text = UserDefaults.standard.string(forKey: kPassword + userTypeStr)
       ...
       // lblTitleEmail.textColor = THEME_COLOR
       // lblTitleEmail.font = UIFont(name: fFONT_MEDIUM, size: calculateFontForWidth(size: 13.0))
        
       // lblTitlePwd.text = "Password"
       // lblTitlePwd.textColor = lblTitleEmail.textColor
       // lblTitlePwd.font = lblTitleEmail.font
        ...
        drawBorder(view: btnCheckbox, color: THEME_COLOR, width: 1.0, radius: 2.0)
        
        lblOR.text = "OR    "
        lblOR.textColor = .gray
        lblOR.font = UIFont(name: fFONT_MEDIUM, size: calculateFontForWidth(size: 13.0))
        lblOR.backgroundColor = VIEW_BG_COLOR
    ...
    func setupUserUI() {
        let isHide: Bool = UserType == .Supplier
        
        lblOR.isHidden = isHide
        viewSocialLogin.isHidden = isHide
        viewOR.isHidden = isHide
        btnRegistration.isHidden = isHide
    ...
    //MARK:- SetUp Apple Login Button its Feature
    ...
    func setupProviderLoginView() {
       ...
       // authorizationButton.cornerRadius = authorizationButton.frame.height/2.0
       }
