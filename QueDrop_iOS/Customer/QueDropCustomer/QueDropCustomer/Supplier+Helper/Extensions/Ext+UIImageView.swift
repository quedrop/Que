...
extension UIImage {
    ...
    static var noImagePlaceHolder: UIImage {
        let placeholder = QUE_AVTAR// #imageLiteral(resourceName: "place_holder")
        return placeholder!
    }
    static var noProfilePlaceHolder: UIImage {
           let placeholder = USER_AVTAR // #imageLiteral(resourceName: "customer")
        return placeholder!
       }
