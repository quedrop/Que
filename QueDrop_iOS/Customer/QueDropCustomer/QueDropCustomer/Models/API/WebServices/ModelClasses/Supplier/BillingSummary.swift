...
public final class BillingSummary: NSObject, NSCoding, JSONable {
  ...
  public var totalDeliveryEarning: Int?
  public var isPaymentDone: Int?
  public var totalTipEarning: Int?
  ...
  public required init(json: JSON) {
    ...
    totalDeliveryEarning = json[SerializationKeys.totalDeliveryEarning].int
    isPaymentDone = json[SerializationKeys.isPaymentDone].int
    totalTipEarning = json[SerializationKeys.totalTipEarning].int
  }
  ...
  required public init(coder aDecoder: NSCoder) {
    ...
    self.totalDeliveryEarning = aDecoder.decodeObject(forKey: SerializationKeys.totalDeliveryEarning) as? Int
    self.isPaymentDone = aDecoder.decodeObject(forKey: SerializationKeys.isPaymentDone) as? Int
    self.totalTipEarning = aDecoder.decodeObject(forKey: SerializationKeys.totalTipEarning) as? Int
  }
