package com.quedrop.customer.utils.localnotification
...
import com.quedrop.customer.utils.KeysUtils.Companion.isSuplplierWeeklyEarning
...
class MyNotificationPublisher : BroadcastReceiver() {
    ...
    companion object {
        ...
        fun getNotification(mContext: Context, title: String, content: String): Notification {
            val myIntent = Intent(mContext, SupplierLoginActivity::class.java)
            myIntent.putExtra(isSuplplierWeeklyEarning, true)
            ...
            builder.color = ContextCompat.getColor(mContext, R.color.colorThemeGreen)
