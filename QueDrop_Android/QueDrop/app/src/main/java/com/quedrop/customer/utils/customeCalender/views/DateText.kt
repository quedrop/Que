    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (isPast) {
            ...
            if (isCurrentMonth && !isDisabled) {
                //zp change to remove today gray circle
                ...
                when (EventsCalendarUtil.SELECTION_MODE) {
                    ...
                    EventsCalendarUtil.RANGE_SELECTION -> {
                        when {
                            EventsCalendarUtil.datesInSelectedRange.contains(EventsCalendarUtil.getDateString(mDate, EventsCalendarUtil.DD_MM_YYYY)) ->
                                when {
                                EventsCalendarUtil.datesInSelectedRange.keys.indexOf(
                                    EventsCalendarUtil.getDateString(mDate, EventsCalendarUtil.DD_MM_YYYY)) == 0 -> {
                                    mDateTextPaint.color = selectedTextColor
                                ...
                                EventsCalendarUtil.datesInSelectedRange.keys.indexOf(
                                    EventsCalendarUtil.getDateString(mDate, EventsCalendarUtil.DD_MM_YYYY)) == EventsCalendarUtil.datesInSelectedRange.size - 1 -> {
                                    mDateTextPaint.color = selectedTextColor
                    ...
                    EventsCalendarUtil.MULTIPLE_SELECTION -> {
                        if (EventsCalendarUtil.datesInSelectedRange.contains(EventsCalendarUtil.getDateString(mDate, EventsCalendarUtil.DD_MM_YYYY)) && !isDisabled) {
                            //zp change
                            //canvas.drawCircle(mCircleX.toFloat(), mCircleY.toFloat(), 0.0f, mDateTextPaint)
                            when {
                                EventsCalendarUtil.datesInSelectedRange.keys.indexOf(
                                    EventsCalendarUtil.getDateString(mDate, EventsCalendarUtil.DD_MM_YYYY)) == 0 ->{
                                    mRangeSelectionEndPaint.color = ContextCompat.getColor(context,R.color.colorThemeGreen)
                                    mDateTextPaint.color = Color.WHITE
                                    canvas.drawRect(RectF(0f, 0f, (mWidth / 2).toFloat(), mHeight.toFloat()), mRangeSelectionEndPaint)
                                    canvas.drawRect(RectF((mWidth / 2).toFloat(), 0f, mWidth.toFloat(), mHeight.toFloat()), mRangeSelectionEndPaint)
                                ...
                                mRangeSelectionEndPaint.color = ContextCompat.getColor(context,R.color.colorAlphaThemeGreen)
                                    mDateTextPaint.color = ContextCompat.getColor(context,R.color.colorCalenderText)
                                    canvas.drawRect(RectF(0f, 0f, (mWidth / 2).toFloat(), mHeight.toFloat()), mRangeSelectionEndPaint)
                                    canvas.drawRect(RectF((mWidth / 2).toFloat(), 0f, mWidth.toFloat(), mHeight.toFloat()), mRangeSelectionEndPaint)
                                    }
                            }
                ...
                if (!isDisabled && EventsCalendarUtil.datesInSelectedRange.contains(
                        EventsCalendarUtil.getDateString(mDate, EventsCalendarUtil.DD_MM_YYYY))) {
