package com.quedrop.customer.base.navigation
...
interface FragmentNavigation {
    ...
    fun AppCompatActivity.addNew(fragment: Fragment, transition: Boolean = false,targetFragment: Fragment? = null,requestCode:Int?=null) {
        supportFragmentManager.beginTransaction().apply {
            if (transition) {
                setCustomAnimations(
                    R.anim.enter_slide_right,
