package com.quedrop.customer.utils.customeCalender.adapter
...
import com.quedrop.customer.utils.customeCalender.views.MonthView
...
class MonthsAdapter(viewPager: EventsCalendar, startMonth: Calendar, endMonth: Calendar) : PagerAdapter() {
    ...
    init {
        ...
        mCount = EventsCalendarUtil.getMonthCount(
            mMinMonth,
            mMaxMonth
        )
