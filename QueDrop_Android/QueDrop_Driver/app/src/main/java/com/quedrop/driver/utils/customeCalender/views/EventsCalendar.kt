...
import com.quedrop.driver.utils.customeCalender.adapter.MonthsAdapter
import com.quedrop.driver.utils.customeCalender.adapter.WeeksAdapter
import com.quedrop.driver.utils.customeCalender.util.EventDots
import com.quedrop.driver.utils.customeCalender.util.Events
    ...
    fun setCurrentSelectedDate(selectedDate: Calendar): EventsCalendar {
        when (EventsCalendarUtil.SELECTION_MODE) {
            SINGLE_SELECTION -> {
                ...
                Log.e("Calender", "2==>" + selectedDate.time)
                EventsCalendarUtil.setCurrentSelectedDate(selectedDate)
                doFocus = true

                reset()
                refreshTodayDate()

                Log.e("Calender", "3==>" + selectedDate.time)
