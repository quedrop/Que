...
<div class="page-header page-header-default">
	<div class="page-header-content">
		<div class="page-title">
			<h4>
				<span class="text-semibold">Edit Fresh Produce Category</span>
			</h4>
		</div>
	</div>
...
<!-- Content area -->
<div class="content">
	<form action="<?php echo base_url('admin/fresh_produce_category/edit/').$category['fresh_category_id']; ?>" id="categoryform" method="POST" enctype="multipart/form-data">
		<div class="row">		
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" type="text" class="form-control" placeholder="Fresh Produce Category Title" id="fresh_produce_title" name="fresh_produce_title" value="<?php echo $category['fresh_produce_title']; ?>">
								</div>
								<div class="form-group">
									<small class="req text-danger"></small>
									...
									<input type="hidden" name="old_image" id="old_image" value="<?php echo $category['fresh_produce_image'];?>">
								</div>
							</div>
						</div>
					</div>
...
$("#categoryform").validate({
	...
	messages: {
		fresh_produce_title: 
		{
			required:"<?php _el('please_enter_', 'Fresh Produce Category') ?>",
		},   
		category_image: {
