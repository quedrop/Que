...
<div class="page-header page-header-default">
    <div class="page-header-content">
        <div class="page-title">
            <h4>
                <span class="text-semibold">Fresh Produce Category</span>
            </h4>
        </div>
    </div>
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active">Fresh Produce Category</li>
        </ul>
    </div>
</div>
<!-- /Page header -->
...
<div class="content">
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
                <a href="<?php echo base_url('admin/fresh_produce_category/add'); ?>" class="btn btn-primary"><?php _el('add_new'); ?><i class="icon-plus-circle2 position-right"></i></a>  
            ...
            <table id="categories_table" class="table  table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" class="checkbox styled"  name="delete"  id="<?php echo $category['fresh_category_id']; ?>">
                        </td>
                        <td><img src="<?php echo DISPLAY_CATEGORY.$category['fresh_produce_image'];?>" alt="<?php echo $category['fresh_produce_title'];?>" style="width: 80px;height:60px;" onError="this.onerror=null;this.src='<?=base_url() . 'assets/admin/images/no_image.png'?>';"></td>
                        <td><?php echo ucfirst($category['fresh_produce_title']); ?></td>
                      <!--   <td class="text-center switchery-sm">
                        ...
                        <td class="text-center">
                            <a data-popup="tooltip" data-placement="top"  title="<?php _el('view') ?>" href="<?php echo site_url('admin/fresh_produce_category/view/').$category['fresh_category_id']; ?>" id="<?php echo $category['fresh_category_id']; ?>" class="text-info">
                                <i class="icon-eye"></i>
                            </a>
                            <a data-popup="tooltip" data-placement="top"  title="<?php _el('edit') ?>" href="<?php echo site_url('admin/fresh_produce_category/edit/').$category['fresh_category_id']; ?>" id="<?php echo $category['fresh_category_id']; ?>" class="text-info">
                                <i class="icon-pencil7"></i>
                            </a>
                        
                        
                            <a data-popup="tooltip" data-placement="top"  title="<?php _el('delete') ?>" href="javascript:delete_record(<?php echo $category['fresh_category_id']; ?>);" class="text-danger delete" id="<?php echo $category['fresh_category_id']; ?>">
...
{ 
    ...
    {       
        $.ajax({
            url:BASE_URL+'admin/fresh_produce_category/delete',
            type: 'POST',
            data: {
                fresh_category_id:id
            },
            success: function(msg)
            {
                if (msg=="true")
                {                    
                    swal({                        
                        title: "<?php _el('_deleted_successfully', 'Fresh Produce Category'); ?>",       
                        type: "success",                            
                    });
...
{     
    ...
    {
        $.ajax({
            url:BASE_URL+'admin/fresh_produce_category/delete_selected',
            type: 'POST',
            data: {
              ids:category_ids
            },
            success: function(msg)
            {
                ...
                {                     
                  swal({                           
                        title: "<?php _el('_deleted_successfully', 'Fresh Produce Categories'); ?>",                    
                        type: "success",                            
                    });
