...
<div class="page-header page-header-default">
    <div class="page-header-content">
        <div class="page-title">
            <h4>
                <span class="text-semibold">Edit Delivery Address</span>
            </h4>
        </div>
    </div>
...
<!-- Content area -->
<div class="content">
    <form action="<?php echo base_url('admin/delivery_address/edit/'.$address[0]->delivery_address_id); ?>" id="deliveryaddressform" method="POST">
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <label>Address:</label>
                                <input type="text" class="form-control" placeholder="Ex : Rhodes, NSW" id="address" name="address" value="<?php echo $address[0]->address?>">
                            </div>
                        </div>
                    </div>
                </div>
