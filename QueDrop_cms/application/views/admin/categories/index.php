...
<div class="content">
    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
                ...
                <a href="<?php echo base_url('admin/categories/add'); ?>" class="btn btn-primary"><?php _el('add_new'); ?><i class="icon-plus-circle2 position-right"></i></a>  
            ...
            <table id="categories_table" class="table  table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th width="20%"><?php _el('store_name'); ?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" class="checkbox styled"  name="delete"  id="<?php echo $category['store_category_id']; ?>">
                        </td>
                        <td><img src="<?php echo DISPLAY_CATEGORY.$category['store_category_image'];?>" alt="<?php echo $category['store_category_title'];?>" style="width: 80px;height:60px;"></td>
                        <td><?php echo ucfirst($category['store_category_title']); ?></td>
                        <td><?php echo ucfirst($category['store_name']);?></td>
                        <td class="text-center switchery-sm">
                            <input type="checkbox" onchange="change_status(this);" class="switchery"  id="<?php echo $category['store_category_id']; ?>" <?php if ($category['is_active']==1) { echo "checked"; }  ?>>
                        </td>
                        
                        <td class="text-center">
                        
                            <a data-popup="tooltip" data-placement="top"  title="<?php _el('edit') ?>" href="<?php echo site_url('admin/categories/edit/').$category['store_category_id']; ?>" id="<?php echo $category['store_category_id']; ?>" class="text-info">
                                <i class="icon-pencil7"></i>
                            </a>
                        
                        
                            <a data-popup="tooltip" data-placement="top"  title="<?php _el('delete') ?>" href="javascript:delete_record(<?php echo $category['store_category_id']; ?>);" class="text-danger delete" id="<?php echo $category['store_category_id']; ?>">
